    ...
    <section className="py-16 px-4 bg-cream-dark">
      <div className="container mx-auto text-center max-w-2xl">
        ...
        <p className="text-muted-foreground mt-4 font-body">
          We are custodians of India's timeless art heritage, bridging the ancient and the modern through handcrafted masterpieces.
        </p>
      </div>
    </section>
      ...
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          ...
          <p className="text-muted-foreground mt-4 font-body leading-relaxed">
            Born from a deep reverence for India's artistic legacy, Kalā Samskruthi Arts began as a humble studio in Bengaluru. Our founder, driven by a passion for preserving dying art forms, traveled across India to learn from master artisans in remote villages.
          </p>
