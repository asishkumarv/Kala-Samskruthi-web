    ...
    <div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto">
          ...
          >
            {siteContent?.homepageText || "Discover exquisite handmade mural arts that celebrate India's rich cultural heritage. Each piece is a unique masterpiece, crafted with passion and tradition."}
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
